...
```bash
git clone https://github.com/msajjauddin/enterprise-rag-app-on-aws
...
- [RAG Backend & Infra](https://github.com/msajjauddin/enterprise-rag-app-on-aws): Terraform infrastructure and backend Lambda codebase.

- [MCP Server](https://github.com/msajjauddin/enterprise-rag-app-on-aws/mcp_servers): MCP Server running locally
---

**Note**: Designed for use with [rag-app-on-aws](https://github.com/msajjauddin/enterprise-rag-app-on-aws) backend infrastructure.