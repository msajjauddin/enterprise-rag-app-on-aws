...
👉 Related Remote MCP Server: [Web Search using SerpAPI](https://github.com/msajjauddin/enterprise-rag-app-on-aws/tree/main/mcp_servers)  Remote MCP Server based on Streaming Http Transport protocol for Real Time Web Search. It's located within the `mcp_servers/` directory of this repository.

👉 Related UI: [RAG UI (Streamlit Frontend)](https://github.com/msajjauddin/enterprise-enterprise-rag-app-on-aws/tree/main/rag_ui)  A Streamlit-based frontend application designed to interact with the backend infrastructure deployed by this project. It's located within the `rag_ui/` directory of this repository.
...
🗺️ [Infra Provisioning Lifecycle Flow](https://github.com/msajjauddin/enterprise-rag-app-on-aws/blob/main/images/infra_provisioning_sequence.png) (Illustrates the Terraform provisioning sequence)
...
1. Fork the Repository
   ...
   👉 https://github.com/msajjauddin/enterprise-rag-app-on-aws
...
2. Clone to Your Local Machine:
    ...
    ```
    git clone https://github.com/<your-github-username>/enterprise-rag-app-on-aws.git
    ```
3. Customize Project Configuration:
   ...
   * `github_repo = "<your-github-username>/enterprise-rag-app-on-aws"` – for CI/CD pipeline setup.
...
2.  **SonarQube Token (Optional)**:
    ...
    * Also, update the following keys in the sonar-project.properties file at the project root:
      ...
      * `sonar.projectKey=<your-sonar-organization-name>_enterprise-rag-app-on-aws`
...
```bash
git clone https://github.com/msajjauddin/enterprise-rag-app-on-aws.git

cd enterprise-rag-app-on-aws/mcp_server
...
👉 UI Readme: https://github.com/msajjauddin/enterprise-rag-app-on-aws/rag_ui
...
* Navigate to the rag-ui directory in your cloned repository using the terminal.
  ...
  ```bash
  cd enterprise-rag-app-on-aws/rag_ui
